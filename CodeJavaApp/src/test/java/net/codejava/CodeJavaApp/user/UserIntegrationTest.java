...
public class UserIntegrationTest {
    ...
    public void addUser_InvalidPassword_Failure() throws Exception{
        ...
        User user = new User("email@gmail.com", "1234567",
    ...
    public void addUser_InvalidEmail_Failure() throws Exception{
        URI uri = new URI(baseUrl + port + "/users");
        User user = new User("email", "12345678",
                "firstname", "lastname", "ROLE_ADMIN");
    ...
    public void deleteUser_ValidUserId_Success() throws Exception {
        ...
        ResponseEntity<Void> result = restTemplate.withBasicAuth("admin@gmail.com", "password")
...
//    @Test
//    public void addUser_AuthoritiesNull_Failure() throws Exception {
//        User user = new User("user@gmail.com", encoder.encode("password123"), "luke", "handsome", null);
//        User admin = new User("admin@gmail.com", encoder.encode("password"), "luke", "handsome", "ROLE_ADMIN");
//        users.save(admin);
//        URI uri = new URI(baseUrl + port + "/users");
//        ResponseEntity<User> result = restTemplate.withBasicAuth("admin@gmail.com", "password")
...
//         URI uri = new URI(baseUrl + port + "/users");
//         users.save(new User("hihi4@gmail.com", encoder.encode("Tester123"),
//                 "john","luke","ROLE_ADMIN"));
